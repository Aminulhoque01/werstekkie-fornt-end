      ...
      <div className="w-full bg-white py-16 md:py-24">
        ...
        <div className="w-full md:container px-5 py-16 grid grid-cols-1 md:grid-cols-2 gap-10">
          <div className="w-full grid grid-cols-2">
            ...
            <img src={image1.src} alt="image" className="size-[390px]" />
            <img src={image2.src} alt="image" className="size-[390px] rounded-bl-full" />
            <img src={image3.src} alt="image" className="size-[390px] rounded-full" />
          </div>
