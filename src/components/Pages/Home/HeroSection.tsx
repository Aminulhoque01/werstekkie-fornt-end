    ...
    <div className="mt-20 flex flex-col items-center justify-center w-full  md:h-[420px] ">
      ...
      <div className="container mx-auto px-12 md:px-12 lg:px-16">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center max-w-[1450px] px-4 md:px-8">
          ...
          {/* Left Content */}
          <div className='px-12 '>
            <h3 className="text-gray-300 text-lg font-semibold mt-5 mb-10">
              Best jobs place
            </h3>
            ...
            <div className="mt-6 w-full lg:w-96 py-5">
              <div className="flex items-center sm:flex-row bg-white p-4 rounded-lg shadow">
                ...
                <button className="lg:w-[55%] ml-4 bg-blue-500 text-white px-3 py-1 md:py-2 rounded-md hover:bg-blue-600">
                  Find Now
                </button>
              </div>
            </div>
          ...
          <div className="md:relative w-full md:h-[450px] lg:justify-end">
            <div className="md:absolute transform rotate-45 md:top-10 items-center lg:ml-10">
                <Image
                  src={heroImage}
                  alt="Job Search"
                  className="w-full h-full lg:h-[400] object-cover transform -rotate-45 lg:ml-8"
                />
            </div>
          </div>
