    ...
    <div>
      ...
      >
        ...
        <Form.Item label="Select Your State/Province" name="state">
          <Select size="large" placeholder="State/Province" className="w-full">
        ...
        <Form.Item label="Select Your Marital Status" name="maritalStatus">
          <Select size="large" placeholder="Marital Status" className="w-full">
        ...
        <div className=" col-span-3 flex gap-5 ">
          <button
            type="submit"
            className="px-6 py-2.5 bg-primary hover:bg-[#193f72] transition-all duration-300 text-white rounded-lg"
          >
            Save Changes
          </button>
          <button onClick={()=>setIsProfileEdit(false)} className="px-6 py-2.5 bg-red-500 hover:bg-red-600 transition-all duration-300 text-white rounded-lg">
            Cancel
          </button>
        </div>
      </Form>
